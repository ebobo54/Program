...
// _Modified_ gnuplot_ipp version by Alberto Ferreira (Feb/2014)
...
/// Same as gnuplot_cmd() but allows wrapping.
void gnuplot_vcmd(gnuplot_ctrl *  handle, char const *  cmd, va_list ap);
 ...
 */
/*--------------------------------------------------------------------------*/
void gnuplot_plot_equation(gnuplot_ctrl * h, const char * equation, const char * title) ;
